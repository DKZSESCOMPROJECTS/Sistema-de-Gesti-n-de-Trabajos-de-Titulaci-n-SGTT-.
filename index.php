...
// Verifica que el archivo exista y que la vista no sea una de las permitidas sin autenticación
            if (is_file("./vistas/" . $_GET['vista'] . ".php") && 
                    !in_array($_GET['vista'], ["login","tesisview", "404", "consulta", "Basesor", "Buscador_KeyWords", "Buscador_Nombre_E", "Todo", "new_user","nuevatesis","sinpermiso"])) {
            ...
            include "./inc/script.php";
                ...
                elseif($_GET['vista']=="sinpermiso"){
                    include "./inc/main.php"; 
                    include "./vistas/sinpermiso.php"; 
                }
